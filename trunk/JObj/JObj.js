...
(function($) {
    ...
    $.getLoadedModule = function(k) {
        return LOADEDMODULE[k];
    }
    $.setLoadedModule = function(k, v) {
        LOADEDMODULE[k] = v
    }
    /*-------------------------------------------------------------------------------------------------*/
    ...
    (function($, $$) {
        ...
        $.getSuccess = function() {
            return eval($$.toSource(SUCCESS))
        };
        $.getFailed = function() {
            return eval($$.toSource(FAILED))
        };
        $.getQueue = function() {
            return eval($$.toSource(QUEUE))
        };
